...
let AuthService = exports.AuthService = class AuthService {
    ...
    async requestPasswordReset({ email }) {
        ...
        return new type_1.BaseMessage('Email sent');
    }
    ...
    async setTheme(theme) {
        ...
        return new type_1.BaseMessage('Theme updated');
    }
    async signout() {
        ...
        return new type_1.BaseMessage('Successfully signed out');
    }
    async deleteAccount() {
        ...
        return new type_1.BaseMessage('Account deleted successfully');
    }
